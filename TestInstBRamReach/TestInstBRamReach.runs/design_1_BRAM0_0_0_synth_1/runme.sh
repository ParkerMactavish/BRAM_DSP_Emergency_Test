...
HD_PWD='D:/desktop/2021-FPGA-Test-Dir/Lab5-DSP_HW/TestInstBRamReach/TestInstBRamReach.runs/design_1_BRAM0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BRAM0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BRAM0_0_0.tcl
