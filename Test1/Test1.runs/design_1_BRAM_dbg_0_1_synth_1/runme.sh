...
HD_PWD='D:/desktop/2021-FPGA-Test-Dir/Lab5-DSP_HW/Test1/Test1.runs/design_1_BRAM_dbg_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BRAM_dbg_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BRAM_dbg_0_1.tcl
